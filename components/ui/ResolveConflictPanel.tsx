                ...
                {Object.keys(member1).map((key) => {
                  ...
                  return (
                    <div key={key} className={`p-3 rounded ${bgColor}`}>
                      <label className="block font-semibold capitalize mb-2">{key}</label>
                      <div className="grid grid-cols-2 gap-2">
                        <div className="border rounded p-1 bg-white">{val1 ?? '—'}</div>
                        <div className="border rounded p-1 bg-white">{val2 ?? '—'}</div>
                      </div>
                    </div>
                  )
                })}
