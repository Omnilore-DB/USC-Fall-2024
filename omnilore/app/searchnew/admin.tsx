        ...
        <div className="w-full flex justify-between">
          <div className="relative w-1/6">
            <Select.Root
              ...
              onValueChange={value => setSelectedView(views[value])}
            >
              <Select.Trigger
            ...
            <thead className="bg-gray-100">
              <tr>
                ...
                roles.includes("registrar") ? (
                  <>
                    <th className="outline outline-gray-200 outline-1 bg-gray-100 px-4 py-2 sticky left-0 z-5">
                      PID
                    </th>
                    {entries.length > 0 &&
                  ...
                  entries.length > 0 &&
                  Object.keys(entries[0]).map(columnName => (
                    <th
                      key={columnName}
                      className="border border-gray-200 px-4 py-2"
                    >
                    ...
                    <>
                      ...
                      {Object.keys(item)
                        ...
                        .map(columnName => (
                          <td
                            key={columnName}
                            className="border border-gray-200 px-4 py-2 group-hover:bg-gray-50"
                          >
                            {item[columnName]}
                          </td>
                        ))}
