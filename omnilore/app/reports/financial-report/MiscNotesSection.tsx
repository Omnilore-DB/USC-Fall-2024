...
export default function MiscNotesSection() {
    ...
    async function fetchData() {
      ...
      try {
        ...
        const uniquePaymentProcessors = Array.from(
          ...
          return transactions.find((item) => item.payment_platform === payment_platform);
        });
  ...
  const handleExport = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Payment Processor Comparison');
  ...
  return (
    <div>
      <h3 className="text-xl font-semibold mb-4">Payment Processor Comparison</h3>
          ...
          <tbody>
            {paymentProcessors.map((item, idx) => (
              <tr key={idx}>
                ...
                <td className="border px-4 py-2">{item.std_processing_charges}</td>
          ...
          <tbody>
            <tr>
              ...
              <td className="border px-4 py-2">
                Both plans are being paid month-to-month; quoted rates are annual rate
              </td>
            </tr>
            <tr>
              ...
              <td className="border px-4 py-2">AO</td>
              <td className="border px-4 py-2">
                I will submit receipts for reimbursement once we hand off payment to OLIR.
              </td>
            </tr>
          </tbody>
        </table>
