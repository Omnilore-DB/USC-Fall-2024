...
const TableSelectDropdown = ({ tables, selectedTable, setSelectedTable }: TableSelectDropdownProps) => {
    return (
            ...
            >
                <Select.Viewport className="p-1">
                    {tables.length > 0 ? (
                        ...
                        <Select.Item value="no-value" disabled className="text-gray-400 px-3 py-2">
                            No views available
                        </Select.Item>
                    )}
                </Select.Viewport>
